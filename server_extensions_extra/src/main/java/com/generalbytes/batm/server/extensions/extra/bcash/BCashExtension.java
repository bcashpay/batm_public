...
import com.generalbytes.batm.server.extensions.extra.bcash.bcashd.BCashRPCWallet;
...
public class BCashExtension extends AbstractExtension {
    private static final CryptoCurrencyDefinition DEFINITION = new BCashDefinition();

    @Override
    public String getName() {
        return "BATM Bcash extension";
    }
    ...
    public ICryptoAddressValidator createAddressValidator(String cryptoCurrency) {
        if (CryptoCurrency.BCASH.getCode().equalsIgnoreCase(cryptoCurrency)) {
    ...
    public IRateSource createRateSource(String sourceLogin) {
        if (sourceLogin != null && !sourceLogin.trim().isEmpty()) {
            ...
            if ("bcashfix".equalsIgnoreCase(exchangeType)) {
    ...
    public Set<String> getSupportedCryptoCurrencies() {
        ...
        result.add(CryptoCurrency.BCASH.getCode());
        return result;
    }
